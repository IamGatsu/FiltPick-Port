...
//    Register sentences for neoforge
...
//                markSlotDirty(i + 36); <- This causes crash bug. Workaround needed
     ...
     * <p>
     * NOTE (26.2 port): {@code ClickType} was replaced by {@link ContainerInput} as the third parameter of
     * {@code clicked}/{@code slotClicked}. {@code ContainerInput} is imported implicitly via the
     * {@code net.minecraft.world.inventory.*} wildcard import above.
     *
     * @param indexOfMenu
     * @param button
     * @param actionType  the click input, wrapping the underlying click type; check the docs for
     *                    {@link ContainerInput} for details
     * @param player
     */
    @Override
    public void clicked(int indexOfMenu, int button, ContainerInput actionType, Player player) {
    ...
    private void onFiltSlotClicked(int slotIndex, ContainerInput actionType) {
